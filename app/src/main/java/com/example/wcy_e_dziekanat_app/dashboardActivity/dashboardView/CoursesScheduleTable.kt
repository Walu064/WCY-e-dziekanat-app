...
val fixedScheduleTimes = listOf("08:00", "09:50", "11:40", "13:30", "15:45", "17:35", "19:30")
    ...
    Column(
        ...
        fixedScheduleTimes.forEach { time ->
            ...
            if (courseAtTime != null) {
                ScheduleRow(fullCourseInfo = courseAtTime, onCourseClicked = onCourseClicked)
            } else {
                val currentDate = LocalDate.now()
                val currentDateTime = currentDate.toString()+"T"+time+"00"
                ScheduleRow(FullCourseInfo(Schedule(date_time = currentDateTime, classroom = "-"))) {}
            }
        }
    }
}